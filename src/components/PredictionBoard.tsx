...
function ForecastCard({ item, onOpen }: { item: BoardPrediction; onOpen: (item: BoardPrediction) => void }) {
  ...
  return (
    <article className="group overflow-hidden rounded-lg border border-court-border bg-court-card transition-colors hover:border-court-accent/70">
      ...
      <div className="space-y-4 p-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="shrink-0 rounded-md border border-court-border bg-court-surface px-2 py-1 text-right">
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          <div className="rounded-md border border-court-border bg-court-surface/60 p-2">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-court-border pt-3 text-xs">
        ...
        {topDrivers.length > 0 && (
          <div className="space-y-1 border-t border-court-border pt-3">
        ...
        <button
          type="button"
          onClick={() => onOpen(item)}
          className="flex w-full items-center justify-center gap-2 rounded-md border border-court-border bg-court-surface px-3 py-2 text-sm font-bold text-white transition-colors hover:border-court-accent"
        >
...
function PredictionDrawer({ item, onClose }: { item: BoardPrediction; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/65 backdrop-blur-sm" role="dialog" aria-modal="true">
      ...
      <aside className="absolute right-0 top-0 flex h-full w-full max-w-xl flex-col border-l border-court-border bg-court-bg shadow-2xl">
        <div className="h-1.5" style={{ background: `linear-gradient(90deg, ${awayColor}, ${homeColor})` }} />
        <div className="flex items-start justify-between gap-4 border-b border-court-border p-5">
          <div className="min-w-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-court-border bg-court-card text-court-muted transition-colors hover:border-court-accent hover:text-white"
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5">
          ...
          <div className="mt-4 rounded-lg border border-court-border bg-court-card p-4">
          ...
          {drivers.length > 0 && (
            <div className="mt-4 rounded-lg border border-court-border bg-court-card p-4">
              ...
              <div className="space-y-2">
                {drivers.map((driver) => (
                  <div key={driver.label} className="rounded-md border border-court-border bg-court-surface/70 p-3">
        ...
        <div className="rounded-lg border border-court-border bg-court-card p-3">
          <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className={`rounded-md px-3 py-1.5 text-xs font-semibold transition-colors ${
                    days === window.days
                      ...
                      : "bg-court-surface text-court-muted hover:text-white"
                  }`}
                >
                  {window.label}
                </button>
            ...
            <select
              ...
              className="min-w-48 rounded-md border border-court-border bg-court-surface px-3 py-1.5 text-xs font-semibold text-white outline-none focus:border-court-accent sm:ml-auto"
            >
        ...
        compact ? (
          <div className="rounded-lg border border-court-border bg-court-card p-5">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className="rounded-md border border-court-border bg-court-surface/70 p-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {days !== 30 && (
                      <button
                        type="button"
                        onClick={() => setDays(30)}
                        className="inline-flex items-center gap-2 rounded-md border border-court-border bg-court-surface px-3 py-2 text-xs font-bold text-white transition-colors hover:border-court-accent"
                      >
